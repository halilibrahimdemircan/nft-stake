...
import ConnectSolanaNoStake from "./ConnectSolanaNoStake";
// import { saveSolanaWallet } from "../apiCalls/sign";

const MyWalletNoStake = (props) => {
        ...
        >
          {
            ...
            >
              {connected ? (
                <ConnectSolanaNoStake connected={connected} />
              ) : (
                <WalletModalProvider>
                  <WalletMultiButton
                    style={{
...
export default MyWalletNoStake;
